...
const HeroSection = ({ isHomePage = false, title, description }) => {
    ...
    <section className="hero" ref={heroRef}>
      ...
      >
        ...
        {isHomePage ? (
          ...
          description && <p className="hero-tagline">{description}</p>
        )}

        {/* Scroll Down Arrow - Always present */}
        <motion.span
