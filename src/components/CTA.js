  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        <a
          href="/contact"
          className="inline-block px-8 py-3 text-lg font-semibold text-white bg-pink-600 rounded-lg shadow-md hover:bg-pink-700 hover:scale-105 transition-all duration-300"
        >
          Get in Touch
        </a>
      </div>
