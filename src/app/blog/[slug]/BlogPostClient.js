...
const BlogPostClient = ({ post }) => {
    ...
    const postDate = new Date(post.date).toLocaleDateString('nb-NO', {
        year: 'numeric',
        month: 'long',
        day: 'numeric'
    });
    ...
    return (
        <div className="post-single bg-slate-50 dark:bg-slate-950 min-h-screen pb-24">
            <HeroSection
                ...
                subtitle="Innsikt fra Aone-teamet"
            />
            ...
            <section className="container mx-auto px-6 -mt-20 relative z-10">
                <div className="max-w-4xl mx-auto">
                    ...
                    <Link href="/blog" className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-8 group transition-colors">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">Tilbake til bloggen</span>
                    </Link>
                    ...
                    >
                            ...
                            <div className="relative w-full h-[30rem]">
                                ...
                                <div className="absolute bottom-10 left-10 right-10 flex flex-wrap items-center gap-8">
                                    <div className="flex items-center gap-3 text-white/90">
                                        ...
                                        <div>
                                            <p className="text-[10px] uppercase font-black tracking-widest opacity-60">Forfatter</p>
                                    ...
                                    <div className="flex items-center gap-3 text-white/90">
                                        ...
                                        <div>
                                            <p className="text-[10px] uppercase font-black tracking-widest opacity-60">Publisert</p>
                                    ...
                                    <div className="flex items-center gap-3 text-white/90">
                                        ...
                                        <div>
                                            <p className="text-[10px] uppercase font-black tracking-widest opacity-60">Lesetid</p>
                        ...
                        <div className="p-10 md:p-16 lg:p-24">
                            ...
                            {post._embedded?.['wp:term']?.[0] && post._embedded['wp:term'][0].length > 0 && (
                                <div className="mt-20 pt-10 border-t border-slate-100 dark:border-slate-800">
                                    <div className="flex flex-wrap items-center gap-4">
                                        <span className="text-[10px] uppercase font-black tracking-widest text-slate-400 mr-2">Emner:</span>
                            ...
                            <div className="mt-16 flex items-center justify-between">
                                ...
                                >
                                    <FaChevronLeft className="text-[10px]" /> Tilbake til bloggen
                                </Link>
