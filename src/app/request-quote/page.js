...
const RequestQuotePage = () => {
  ...
  return (
    <div className="request-quote-page bg-gray-50 dark:bg-background-color min-h-screen">
      <HeroSection
        title="Request a Quote"
        description="Tell us about your project and get a personalized quote."
      />
      <section className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto bg-white dark:bg-light-gray p-8 rounded-lg shadow-lg">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Project Details</h2>
          {message && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Service(s) of Interest <span className="text-red-500 dark:text-red-400">*</span>
              </label>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {services.map((service) => (
                  <div key={service} className="flex items-center">
                    ...
                    />
                    <label htmlFor={service} className="ml-2 block text-sm text-gray-900 dark:text-gray-100">
                      {service}
                    </label>
                  </div>
                ))}
            ...
            <div>
              <label htmlFor="budget" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Estimated Budget <span className="text-red-500 dark:text-red-400">*</span>
              </label>
              <select
                id="budget"
                name="budget"
            ...
            <div>
              <label htmlFor="timeline" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Desired Timeline <span className="text-red-500 dark:text-red-400">*</span>
              </label>
              <select
                id="timeline"
                name="timeline"
