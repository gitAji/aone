const projects = [
  ...
  },
  {
    ...
    features: [
      "AI-Powered Smart Reservation Assistant",
      "Mobile-first responsive design (sub-1s load)",
      "Stunning brand-aligned food photography",
      "Engaging high-conversion video content",
