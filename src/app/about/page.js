...
const AboutPage = () => {
  return (
    <div className="about-page bg-gray-50 dark:bg-background-color min-h-screen">
      <HeroSection title="About Us" description="Learn more about our company" />
      ...
      <section className="why-choose-us container mx-auto px-4 py-16">
        ...
        <div className="metrics grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="metric bg-white dark:bg-light-gray p-8 rounded-lg shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-5xl font-bold text-blue-600 dark:text-blue-400 mb-2">
              <CountUp end={15} duration={2.5} />+
            </h3>
            <p className="text-xl text-gray-700 dark:text-gray-300">Years of Expertise</p>
          </div>
          <div className="metric bg-white dark:bg-light-gray p-8 rounded-lg shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-5xl font-bold text-green-600 dark:text-green-400 mb-2">
              <CountUp end={200} duration={2.5} />+
            </h3>
            <p className="text-xl text-gray-700 dark:text-gray-300">Happy Clients</p>
          </div>
          <div className="metric bg-white dark:bg-light-gray p-8 rounded-lg shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-5xl font-bold text-purple-600 dark:text-purple-400 mb-2">
              <CountUp end={250} duration={2.5} />+
            </h3>
            <p className="text-xl text-gray-700 dark:text-gray-300">Projects are done</p>
          </div>
        </div>
      </section>

      <section className="mission-vision bg-white dark:bg-background-color py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-100 mb-12 text-center">
            Our Mission, Vision & Values
          </h2>
          <div className="values-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="value-item bg-gray-50 dark:bg-light-gray p-8 rounded-lg shadow-md transform transition duration-300 hover:scale-105 hover:shadow-lg">
      ...
      <section className="our-story container mx-auto px-4 py-16 bg-white dark:bg-background-color">
        <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-100 mb-12 text-center">
          Our Story
        </h2>
        <div className="story-content max-w-3xl mx-auto text-lg text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
          <p>
      ...
      <section className="testimonials-section py-16 bg-white dark:bg-background-color">
        <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-100 mb-12 text-center">
          What Our Clients Say
        </h2>
        <div className="testimonials-grid container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="testimonial-item bg-gray-100 dark:bg-light-gray p-8 rounded-lg shadow-md flex flex-col justify-between">
            <p className="review-text text-lg italic text-gray-800 dark:text-gray-200 mb-6">
            ...
            <p className="client-name text-right font-semibold text-gray-900 dark:text-gray-100 flex items-center justify-end">
              <Image
