...
const ReferralPage = () => {
  ...
  return (
    <div className="referral-page bg-gray-50 dark:bg-background-color min-h-screen">
      <HeroSection
        title="Refer a Client"
        description="Help us grow and get rewarded!"
      />
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto bg-white dark:bg-light-gray p-8 rounded-lg shadow-lg">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Referral Form</h2>
          {message && (
