...
import { FaVideo, FaFilm, FaLightbulb, FaMicrophoneAlt, FaEdit, FaShareAlt, FaChartLine, FaArrowDown } from 'react-icons/fa';
...
const VideographyPage = () => {
  return (
    <div className="service-detail-page bg-gray-50 min-h-screen">
      <HeroSection
        title="Videography"
        description="Capturing compelling stories and creating stunning visual content that resonates with your audience."
      />
