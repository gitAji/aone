        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-8 rounded-lg shadow-md bg-gray-50">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Expertise & Experience</h3>
              <p className="text-gray-700">Our team comprises seasoned professionals with years of experience in their respective fields, ensuring top-notch quality and innovative solutions.</p>
            </div>
            <div className="p-8 rounded-lg shadow-md bg-gray-50">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Client-Centric Approach</h3>
              <p className="text-gray-700">We prioritize your vision and goals, working closely with you throughout the project to deliver tailored solutions that exceed expectations.</p>
            </div>
            <div className="p-8 rounded-lg shadow-md bg-gray-50">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Proven Track Record</h3>
              <p className="text-gray-700">Our portfolio showcases a diverse range of successful projects and satisfied clients, demonstrating our ability to deliver tangible results.</p>
            </div>
          </div>
        </div>
      </section>
