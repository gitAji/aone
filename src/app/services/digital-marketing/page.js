  ...
  return (
    <div className="service-detail-page bg-gray-50 min-h-screen">
      <HeroSection
        ...
        subtitle="Driving measurable results and maximizing your online presence with data-driven strategies."
      />
      ...
      <section className="cta py-16 bg-blue-700 text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-8">Ready to elevate your digital presence?</h2>
