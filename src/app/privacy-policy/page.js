    ...
    <div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Accordion title="6. Policy for Children">
          <p className="mb-4">
            We do not knowingly solicit information from or market to children under the age of 13. If you become aware of any data we have collected from children under age 13, please <Link href="/contact" className="text-blue-600 hover:underline">contact us</Link> using the contact information provided below.
          </p>
        </Accordion>
        ...
        <Accordion title="8. Contact Us">
          <p className="mb-4">
            If you have questions or comments about this Privacy Policy, please <Link href="/contact" className="text-blue-600 hover:underline">contact us</Link> at:
          </p>
          <p className="mb-4">
            Aone.no<br/>
